...
dbRoute.post('/comments', (req: Request, res: Response) => {
    ...
    dbController.insertComment(newComment.commentId,
                                newComment.gameID,
                                newComment.userID,
...
dbRoute.post('/users', (req: Request, res: Response) => {
    ...
    dbController.insertUser(newUser.userID, newUser.profileName, newUser.profileDescription).then(() => {
        res.status(StatusCodes.OK);
...
dbRoute.delete('/comments/:id', (req: Request, res: Response) => {
    dbController.deleteComment(+req.params.id).then(() => {
        res.status(StatusCodes.OK);
...
dbRoute.delete('/users/:id', (req: Request, res: Response) => {
    dbController.deleteUser(+req.params.id).then(() => {
        res.status(StatusCodes.OK);
...
dbRoute.delete('/games/:id', (req: Request, res: Response) => {
    dbController.deleteGame(+req.params.id).then(() => {
        res.status(StatusCodes.OK);
...
dbRoute.put("/comments/:id", (req: Request, res: Response) => {
    dbController.updateComment(+req.params.id, req.body.update, req.body.isArray).then(() => {
        res.status(StatusCodes.OK);
...
dbRoute.put("/games/:id", (req: Request, res: Response) => {
    dbController.updateGame(+req.params.id, req.body.update, req.body.isArray).then(() => {
        res.status(StatusCodes.OK);
...
dbRoute.put("/users/:id", (req: Request, res: Response) => {
    dbController.updateUser(+req.params.id, req.body.update, req.body.isArray).then(() => {
        res.status(StatusCodes.OK);
